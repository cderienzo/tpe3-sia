...
class Ui_GeneticAlgorithm(object):
    def setupUi(self, GeneticAlgorithm):
        ...
        GeneticAlgorithm.resize(1039, 671)
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(420, 90, 181, 41))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(420, 150, 201, 41))
        self.label_2.setObjectName("label_2")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(420, 210, 181, 41))
        self.label_4.setObjectName("label_4")
        self.generation = QtWidgets.QLabel(self.centralwidget)
        self.generation.setGeometry(QtCore.QRect(630, 90, 221, 41))
        self.generation.setObjectName("generation")
        self.pm = QtWidgets.QLabel(self.centralwidget)
        self.pm.setGeometry(QtCore.QRect(630, 150, 221, 41))
        self.pm.setObjectName("pm")
        self.fitness = QtWidgets.QLabel(self.centralwidget)
        self.fitness.setGeometry(QtCore.QRect(630, 210, 221, 41))
        self.fitness.setObjectName("fitness")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(570, 550, 211, 81))
        self.pushButton.setObjectName("pushButton")
        self.end = QtWidgets.QLabel(self.centralwidget)
        self.end.setGeometry(QtCore.QRect(450, 440, 181, 41))
        self.end.setText("")
        self.end.setObjectName("end")
        self.character = QtWidgets.QLabel(self.centralwidget)
        self.character.setGeometry(QtCore.QRect(20, 40, 381, 571))
        self.character.setText("")
        self.character.setObjectName("character")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(420, 270, 181, 41))
        self.label_5.setObjectName("label_5")
        self.height = QtWidgets.QLabel(self.centralwidget)
        self.height.setGeometry(QtCore.QRect(630, 270, 221, 41))
        self.height.setObjectName("height")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(420, 330, 181, 41))
        self.label_6.setObjectName("label_6")
        self.items = QtWidgets.QLabel(self.centralwidget)
        self.items.setGeometry(QtCore.QRect(630, 330, 401, 51))
